                        ...
                        <template v-if="dataRow.browse == 1">
                          ...
                          <div
                            v-else-if="
                              dataRow.type == 'switch'
                            "
                            class="crud-generated__item--switch"
                          >
                            <badaso-switch v-if="record[$caseConvert.stringSnakeToCamel(dataRow.field)] ==1" value="0"  onLabel="" offLabel=""></badaso-switch>
                            <badaso-switch v-else onLabel="" offLabel=""></badaso-switch>
